-- FUNCTION: public.get_total_trabajador(integer, text, integer, integer, integer, date, date)

-- DROP FUNCTION public.get_total_trabajador(integer, text, integer, integer, integer, date, date);

CREATE OR REPLACE FUNCTION public.get_total_trabajador(
...
ALTER FUNCTION public.get_total_trabajador(integer, text, integer, integer, integer, date, date)
    OWNER TO postgres;
