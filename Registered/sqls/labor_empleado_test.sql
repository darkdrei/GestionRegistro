-- Function: labor_empleado_test(integer)

-- DROP FUNCTION labor_empleado_test(integer);

CREATE OR REPLACE FUNCTION labor_empleado_test(id_labor integer)
  RETURNS boolean AS
$BODY$
declare
    temporal record;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION labor_empleado_test(integer)
  OWNER TO postgres;
