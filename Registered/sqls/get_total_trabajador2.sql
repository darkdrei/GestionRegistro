-- FUNCTION: public.get_total_trabajador2(integer, text, integer, integer, integer, date, date)

-- DROP FUNCTION public.get_total_trabajador2(integer, text, integer, integer, integer, date, date);
