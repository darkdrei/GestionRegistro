create or replace function get_total_trabajador(id_supervisor integer,busqueda text,empresa integer,tienda integer,ciudad integer, inicio date,finalizar date) returns json as $$
begin
