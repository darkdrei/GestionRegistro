...
$(document).on('ready', function(){
  $('#editempleado').modal();
  $('.edit_modal_empleado').on('click',function(event){
    return false;
  });
  $('.edit_modal_empleado').on('click',function(event){
    var options = {
...
function funcionesModificar(){
  $('.modf_empleado').on('click', function(event){
    console.log("++++++++++++++++++++++++++++");
    return false;
  });
  $('.modf_empleado').on('click', function(event){
    console.log($(this).attr('href'));
    $('a.edit_modal_empleado').attr('href',$(this).attr('href'));
