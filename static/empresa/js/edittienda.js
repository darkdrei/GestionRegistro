...
$(document).on('ready', function(){
  $('#edittienda').modal();
  $('.edit_modal_tienda').on('click',function(event){
    return false;
  });
  $('.edit_modal_tienda').on('click',function(event){
    var options = {
...
function funcionesModificarTienda(){
  $('.modf_tienda').on('click', function(event){
    console.log("++++++++++++++++++++++++++++");
    return false;
  });
  $('.modf_tienda').on('click', function(event){
    console.log($(this).attr('href'));
    $('a.edit_modal_tienda').attr('href',$(this).attr('href'));
