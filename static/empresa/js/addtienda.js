$(document).on('ready', function(){
  ...
  $('.addtienda').on('click', function(event){
    $("#contenido").load($(this).attr('href'),function(responseTxt, statusTxt, xhr){
          ...
          $('.savetienda').on('click',function(event){
            var options = {
