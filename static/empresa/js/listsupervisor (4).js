...
$(document).on('ready', function(){
  $('#editempresa').modal();
  $('.edit_modal_empresa').on('click',function(event){
    return false;
  });
  $('.edit_modal_empresa').on('click',function(event){
    var options = {
...
function funcionesModificarEmpresa(){
  $('.modf_empresa').on('click', function(event){
    console.log("++++++++++++++++++++++++++++");
    return false;
  });
  $('.modf_empresa').on('click', function(event){
    console.log($(this).attr('href'));
    $('a.edit_modal_empresa').attr('href',$(this).attr('href'));
