    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono_fijo', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(re.compile('^[0-9]+$'), 'telefono no valido', 'invalid')])),
                ('telefono_celular', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(re.compile('^[0-9]+$'), 'telefono no valido', 'invalid')])),
            ],
            options={
                'abstract': False,
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='usuario',
            name='documeno',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuario.Documento'),
        ),
    ]
