...
class EmpleadoForm(UserCreationForm):
    def __init__(self, *args, **kwargs):
        ...
        print self.fields['fecha_nacimiento'].widget.attrs.get('class'), ' Clases desde el admon'
        if self.fields['fecha_nacimiento'].widget.attrs.has_key('class'):
            clases =  '%s %s'%(self.fields['fecha_nacimiento'].widget.attrs['class'],'datepicker')
            self.fields['fecha_nacimiento'].widget.attrs.update({'class': clases})
        #end if
        print clases
    # end def
